 ...
 */
	public function error($field, $text = null, $options = array()) {
		...
		if ($options['wrap']) {
                       ...
                       return '<div class="errorbox">'.$this->Html->tag($tag, $error, $options).'<div class="error-arrow"></div></div>';  
 ...
 */
	public function postLink($title, $url = null, $options = array(), $confirmMessage = false) {
		...
		if ($confirmMessage) {
			...
			if(isset($options['nativeconfirmbox']) && !empty($options['nativeconfirmbox']))
			{
			...
			{
				$options['onclick'] ='';
				$options['rel'] 	= 'postlink';
				$options['data-message'] 	= $confirmMessage;
				$options['data-title'] 		= 'Confirm';
			}
